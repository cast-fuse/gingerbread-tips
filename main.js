...
var _cast_fuse$gingerbread_tips$Model$Model = F2(
	function (a, b) {
		return {tips: a, history: b};
	});
...
var _cast_fuse$gingerbread_tips$Model$TipsResponse = function (a) {
...
var _cast_fuse$gingerbread_tips$Request_Tip$nonHtmlString = A2(
	_elm_lang$core$Json_Decode$map,
	function (_p0) {
		return _jinjor$elm_html_parser$HtmlParser_Util$textContent(
			_jinjor$elm_html_parser$HtmlParser$parse(_p0));
	},
	_elm_lang$core$Json_Decode$string);
var _cast_fuse$gingerbread_tips$Request_Tip$tagDecoder = A2(
...
var _cast_fuse$gingerbread_tips$Update$initialState = function (location) {
	return {
		tips: _krisajenkins$remotedata$RemoteData$Loading,
		history: {
			ctor: '::',
			_0: location,
			_1: {ctor: '[]'}
...
var _cast_fuse$gingerbread_tips$Update$init = function (location) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		_cast_fuse$gingerbread_tips$Update$initialState(location),
		{
			ctor: '::',
			_0: _cast_fuse$gingerbread_tips$Request_Tip$getTips,
			_1: {ctor: '[]'}
		});
};
...
var _cast_fuse$gingerbread_tips$View$renderTip = function (tip) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('bg-light-blue mv4 pa4 tl br2'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
	...
	switch (_p0.ctor) {
		...
		case 'Loading':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('loading Tips'),
					_1: {ctor: '[]'}
				});
		case 'Failure':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Sorry there was a problem loading the data'),
					_1: {ctor: '[]'}
				});
		default:
			var _p1 = _p0._0;
...
var _cast_fuse$gingerbread_tips$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('tc blue mt5'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Gingerbread Tips'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _cast_fuse$gingerbread_tips$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_cast_fuse$gingerbread_tips$Model$UrlChange,
	{
		update: _cast_fuse$gingerbread_tips$Update$update,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
		view: _cast_fuse$gingerbread_tips$View$view,
		init: _cast_fuse$gingerbread_tips$Update$init
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _cast_fuse$gingerbread_tips$Main$main !== 'undefined') {
    _cast_fuse$gingerbread_tips$Main$main(Elm['Main'], 'Main', undefined);
}
